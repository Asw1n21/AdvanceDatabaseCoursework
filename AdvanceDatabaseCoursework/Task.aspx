<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Task.aspx.cs" Inherits="AdvanceDatabaseCoursework.Task" %>
        ...
        <asp:GridView ID="GridView1" CssClass ="table table-bordered"  runat="server" AutoGenerateColumns="False" DataKeyNames="TASK_ID" DataSourceID="SqlDataSource1">
            <Columns>
                ...
                <asp:TemplateField HeaderText="MILESTONE_NAME">
                    <ItemTemplate>
                        <asp:DropDownList Enabled ="false" ID="DropDownList2" runat="server" DataSourceID="SqlDataSource3" DataTextField="MILESONE_NAME" DataValueField="MILESTONE_ID" SelectedValue='<%# Bind("MILESTONE_ID") %>'>
                        </asp:DropDownList>
                        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" SelectCommand="SELECT &quot;MILESTONE_ID&quot;, &quot;MILESONE_NAME&quot; FROM &quot;MILESTONES&quot;"></asp:SqlDataSource>
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
        </asp:GridView>
        ...
        <asp:FormView ID="FormView1" runat="server" DataKeyNames="TASK_ID" DataSourceID="SqlDataSource1">
            ...
            <InsertItemTemplate>
              <div class="form-container">
                ...
                <br />
                MILESTONE_ID:
                <asp:DropDownList ID="DropDownList1" runat="server" DataSourceID="SqlDataSource2" DataTextField="MILESONE_NAME" DataValueField="MILESTONE_ID" SelectedValue='<%# Bind("MILESTONE_ID") %>'>
                </asp:DropDownList>
                <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" SelectCommand="SELECT &quot;MILESTONE_ID&quot;, &quot;MILESONE_NAME&quot; FROM &quot;MILESTONES&quot;"></asp:SqlDataSource>
                <br />
            ...
            <ItemTemplate>
                <div class="button-container">
                 <asp:LinkButton ID="LinkButton1" runat="server" CausesValidation="False" CommandName="New" Text=" Add New Task" CssClass="btn" />
                  </div>
            </ItemTemplate>
        </asp:FormView>
    </form>
