...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" DeleteCommand="DELETE FROM &quot;SUBTASKS&quot; WHERE &quot;SUBTASK_ID&quot; = :SUBTASK_ID" InsertCommand="INSERT INTO &quot;SUBTASKS&quot; (&quot;SUBTASK_ID&quot;, &quot;SUBTASK_NAME&quot;, &quot;SUBTASK_STARTDATE&quot;, &quot;SUBTASK_ENDDATE&quot;, &quot;SUBTASK_STATUS&quot;, &quot;USER_ID&quot;, &quot;TASK_ID&quot;) VALUES (:SUBTASK_ID, :SUBTASK_NAME, :SUBTASK_STARTDATE, :SUBTASK_ENDDATE, :SUBTASK_STATUS, :USER_ID, :TASK_ID)" ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" SelectCommand="SELECT &quot;SUBTASK_ID&quot;, &quot;SUBTASK_NAME&quot;, &quot;SUBTASK_STARTDATE&quot;, &quot;SUBTASK_ENDDATE&quot;, &quot;SUBTASK_STATUS&quot;, &quot;USER_ID&quot;, &quot;TASK_ID&quot; FROM &quot;SUBTASKS&quot;" UpdateCommand="UPDATE &quot;SUBTASKS&quot; SET &quot;SUBTASK_NAME&quot; = :SUBTASK_NAME, &quot;SUBTASK_STARTDATE&quot; = :SUBTASK_STARTDATE, &quot;SUBTASK_ENDDATE&quot; = :SUBTASK_ENDDATE, &quot;SUBTASK_STATUS&quot; = :SUBTASK_STATUS, &quot;USER_ID&quot; = :USER_ID, &quot;TASK_ID&quot; = :TASK_ID WHERE &quot;SUBTASK_ID&quot; = :SUBTASK_ID">
                <DeleteParameters>
            ...
            <asp:FormView ID="FormView1" runat="server" DataKeyNames="SUBTASK_ID" DataSourceID="SqlDataSource1" OnPageIndexChanging="FormView1_PageIndexChanging">
                <EditItemTemplate>
             ...
             <div class="button-container">
                    &nbsp;<asp:LinkButton ID="NewButton" runat="server" CausesValidation="False" CommandName="New" Text="New Subtask" CssClass="btn btn-new" />
                 </div>
                </ItemTemplate>
            </asp:FormView>
        </div>
